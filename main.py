...
if move_3 == "outside":
            ...
            print("Spotter: Good call Jeff, you nailed it!")
            print("You: Yeah, we did it!")
            print("Spotter: Alright, we've got this. Just keep it steady for one more lap.")
            print("You cross the finish line and the crowd erupts. You've won the race and secured your spot in the final four.")
            print("You: This is it, we're going for the championship!")
            ...
            if move_4 == "push":
                ...
                print("Suddenly you hear a pop behind you and you start sliding across the track. Desperate to save it, you brake hard and turn the steering wheel. But it's no use and you crash into the wall. The cars that were previously behind you zoom right past you and you end up last.")
            if move_4 == "slow":
